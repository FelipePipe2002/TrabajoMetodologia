...
public class SendEmail {
	...
	private static String getSubject(String doctor) {				
		return " ¡Turno confirmado! Turno con " + doctor;
	}
	
	private static String getContent(String paciente, String doctor, Direccion  direccion, String fecha) {
    ...
    public static void send(String emailPaciente, String paciente, String doctor, Direccion direccion, String fecha) {
        ...
        try {
            ...
            message.setSubject(getSubject(doctor));
            message.setContent(getContent(paciente, doctor, direccion, fecha), "text/html");
